...
interface ValueGenerator
{
    ...
    // TODO принимает разрешенные или запрещенные символы, в соответствии с настройками

    // TODO возможность обертки выходных значений, например, удаление или замена пробелов
